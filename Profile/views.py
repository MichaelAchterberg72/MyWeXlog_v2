...
def ProfileView(request):
    ...
    if detail.talent == request.user:
        ...
        context = {
            'info':info, 'email':email, 'physical':physical, 'postal': postal, 'pnumbers': pnumbers, 'online': online, 'id': id, 'passport': passport, 'speak': speak, 'history': history, 'user_info': user_info, 'tlt': tlt, 'relocate': relocate, 'upload': upload, 'lcm_qs': lcm_qs,'achievement': achievement,
            }
