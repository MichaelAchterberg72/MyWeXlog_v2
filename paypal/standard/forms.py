...
from paypal.standard.conf import (BUY_BUTTON_IMAGE, DONATION_BUTTON_IMAGE,
                                  PAYPAL_CERT, PAYPAL_CERT_ID,
                                  PAYPAL_PRIVATE_CERT, PAYPAL_PUBLIC_CERT,
...
class PayPalPaymentsForm(forms.Form):
    ...
    {1}
    <input type="submit" value="Subscribe Now" src="{2}" border="0" name="submit" alt="Subscribe Now" class="btn btn-outline-primary btn-block" align="center"/>
