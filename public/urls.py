...
#    path('landing-page/contact/', views.ContactUsView, name='ContactUs'),
#    path('landing-page/contact/thank-you/', views.ThankContactView.as_view(), name='ThankContactUs'),
...
#    path('landing-page/data-protection-officer/', views.DataProtectionView, name='DataProtection'),
